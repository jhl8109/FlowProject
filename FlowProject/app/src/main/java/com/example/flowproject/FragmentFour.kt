...
class FragmentFour : Fragment() {
    ...
    override fun onCreateView(
        ...
        progressAnimator1 = ObjectAnimator.ofInt(progressBar1, "progress", 99)
        progressAnimator1.setDuration(1500)
        progressAnimator1.start()

        val progressAnimator2: ObjectAnimator
        progressAnimator2 = ObjectAnimator.ofInt(progressBar2, "progress", 1)
        progressAnimator2.setDuration(1500)
        progressAnimator2.start()


        entries.add(BarEntry(0f, 25.0f))
